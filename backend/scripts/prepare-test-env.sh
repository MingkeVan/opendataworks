...
echo ""
echo "3. 导出环境变量(用于测试运行)："
echo "   export DS_BASE_URL=$DOLPHIN_URL"
echo "   export DS_TOKEN=\"...\" (使用上方获取的Token)"
echo "   export DS_PROJECT_NAME=$PROJECT_NAME"
echo ""
echo "4. 运行测试："
echo "   cd backend"
echo "   mvn test -Dtest=RealDolphinSchedulerIntegrationTest"
echo "========================================="
