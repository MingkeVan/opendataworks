...
> **状态：已被替代（2026-08-17）。** 本文保留 stdio bridge 阶段的 CLI 取证与设计历史；当前实现见 [`2026-08-17-portal-mcp-streamable-http-design.md`](./2026-08-17-portal-mcp-streamable-http-design.md)，不应再据此恢复 bridge。
