...
.query-workbench.is-floating .query-suggestion-pill {
  padding: 4px 12px;
  font-size: 11px;
}
...
.query-process-thought-content code {
  padding: 2px 6px;
  border-radius: 6px;
  background: color-mix(in srgb, var(--odw-widget-color, #4A90A4) 8%, transparent);
...
.query-main-text pre,
.query-process-thought-content pre {
  padding: 12px;
  border-radius: 8px;
  background: #f6f8fb;
  overflow-x: auto;
...
.query-main-text pre code,
.query-process-thought-content pre code {
  padding: 0;
  border-radius: 0;
  background: transparent;
  color: inherit;
